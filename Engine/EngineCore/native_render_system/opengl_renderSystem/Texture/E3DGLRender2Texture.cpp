...
void E3DEngine::GL_Render2Texture::Update(float deltaTime)
{
...
void E3DEngine::GL_Render2Texture::SetTextureUniformIndex(int index, UINT program)
{
...
void E3DEngine::GL_Render2Texture::ActiveBindTexture()
{
...
void E3DEngine::GL_Render2Texture::InvalidTexture()
{
	glBindTexture(GL_TEXTURE_2D, 0);
}

void E3DEngine::GL_Render2Texture::SetClampType(int tp)
{

}

void E3DEngine::GL_Render2Texture::SetFilterType(int tp)
{
